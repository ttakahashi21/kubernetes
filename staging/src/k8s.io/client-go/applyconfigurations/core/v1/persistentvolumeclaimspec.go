...
type PersistentVolumeClaimSpecApplyConfiguration struct {
	...
	DataSourceRef2   *TypedCrossNamespaceObjectReferenceApplyConfiguration `json:"dataSourceRef2,omitempty"`
}
...
// WithDataSourceRef2 sets the DataSourceRef2 field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the DataSourceRef2 field is set to the value of the last call.
func (b *PersistentVolumeClaimSpecApplyConfiguration) WithDataSourceRef2(value *TypedCrossNamespaceObjectReferenceApplyConfiguration) *PersistentVolumeClaimSpecApplyConfiguration {
	b.DataSourceRef2 = value
	return b
}
