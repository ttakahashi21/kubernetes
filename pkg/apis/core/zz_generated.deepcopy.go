...
func (in *PersistentVolumeClaimSpec) DeepCopyInto(out *PersistentVolumeClaimSpec) {
	*out = *in
	...
	if in.DataSourceRef2 != nil {
		in, out := &in.DataSourceRef2, &out.DataSourceRef2
		*out = new(TypedCrossNamespaceObjectReference)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TypedCrossNamespaceObjectReference) DeepCopyInto(out *TypedCrossNamespaceObjectReference) {
	*out = *in
	if in.APIGroup != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TypedCrossNamespaceObjectReference.
func (in *TypedCrossNamespaceObjectReference) DeepCopy() *TypedCrossNamespaceObjectReference {
	if in == nil {
		return nil
	}
	out := new(TypedCrossNamespaceObjectReference)
